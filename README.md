...
> ⚠️ **«СберБум 2.0» (Aura) — в тестовом режиме.** Поддержка добавлена по
> выгрузке протокола устройства от владельца и не проверялась на живой
> колонке. Базовые сущности и настройки колонки работают через общий слой,
> но возможны неточности. Нашли проблему — заведите issue (кнопка
> «⬇ Дамп настроек» в модалке колонки → таб «🔊 Звук» приложит нужные данные).
