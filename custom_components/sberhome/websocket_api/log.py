...
@websocket_api.websocket_command(
    {vol.Required("type"): "sberhome/message_log"}
)
@callback
def ws_message_log(
    hass: HomeAssistant,
...
@websocket_api.websocket_command(
    {vol.Required("type"): "sberhome/clear_message_log"}
)
@callback
...
@websocket_api.websocket_command(
    {vol.Required("type"): "sberhome/subscribe_messages"}
)
@callback
def ws_subscribe_messages(
    ...
    connection.send_message(
        websocket_api.event_message(
            msg["id"], {"snapshot": list(coord._ws_log)}
        )
    )
