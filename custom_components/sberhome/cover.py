...
class SberSbermapCover(SberBaseEntity, CoverEntity):
    ...
    async def async_set_cover_position(self, **kwargs: Any) -> None:
        await self._async_send_attrs(
            build_cover_position_command(device_id=self._device_id, position=kwargs[ATTR_POSITION])
        )

    async def async_stop_cover(self, **kwargs: Any) -> None:
        await self._async_send_attrs(build_cover_stop_command(device_id=self._device_id))
