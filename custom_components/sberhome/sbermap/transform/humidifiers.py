...
def build_humidifier_on_off_command(*, device_id: str, is_on: bool) -> list[AttributeValueDto]:
...
def build_humidifier_set_mode_command(*, device_id: str, mode: str) -> list[AttributeValueDto]:
