...
class TestDoorSensor:
    @pytest.fixture
    def entity(self, mock_coordinator_with_entities):
        return _bs_by_id(mock_coordinator_with_entities, "device_door_1", "device_door_1")
...
class TestMotionSensor:
    @pytest.fixture
    def entity(self, mock_coordinator_with_entities):
        return _bs_by_id(mock_coordinator_with_entities, "device_motion_1", "device_motion_1")
